    ...
    public void renderComponent() {
        ...
        if (op.getValBoolean()) {
            if (Past.settingsManager.getSettingID("ClickGUIRainbow").getValBoolean()) {
                ...
                Gui.drawRect(parent.parent.getX(), parent.parent.getY() + offset, parent.parent.getX() + parent.parent.getWidth(), parent.parent.getY() + offset + 15, GUIColourUtil.getGUIColour());
            }
