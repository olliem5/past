...
public class DoubleComponent extends Component {
    ...
    public void renderComponent() {
        ...
        if (Past.settingsManager.getSettingID("ClickGUIRainbow").getValBoolean()) {
            ...
            Gui.drawRect(parent.parent.getX() + 1, parent.parent.getY() + offset, parent.parent.getX() + (int) sliderWidth - 1, parent.parent.getY() + offset + 15, ClickGUIUtil.getGUIColour());
        }
